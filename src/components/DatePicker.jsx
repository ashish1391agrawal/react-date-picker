...
export class DatePicker extends Component {
    ...
    componentWillMount() {
        ...
        const month = moment(this.props.value ? this.props.value : cuurrentDate, "DD/MM/YYYY").month() + 1;
    ...
    getDaysArray(year, month) {
        ...
        while (date.getMonth() === month - 1) {
            result.push({day: date.getDate(), week: weeks[date.getDay()], fullDate: date.getTime()});
