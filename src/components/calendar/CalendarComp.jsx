    ...
    componentWillMount() {
        if (this.props.disabledDays && this.props.disabledDays.length > 0) {
            ...
            this.props.disabledDays.map((data) => {
                ...
                if(this.props.id.day === day && moment(data, "DD/MM/YYYY").year() === this.props.year && moment(data, "DD/MM/YYYY").month() + 1 === this.props.month) {
        ...
        if(this.props !== nextProps){
            ...
            if (nextProps.disabledDays && nextProps.disabledDays.length > 0) {
                ...
                nextProps.disabledDays.map((data) => {
                    const day = moment(data, "DD/MM/YYYY").date();
                    if(nextProps.id.day === day && moment(data, "DD/MM/YYYY").year() === nextProps.year && moment(data, "DD/MM/YYYY").month() + 1 === nextProps.month) {
                        this.setState({disabledClick: true});
                    }
                    return null;
                });
